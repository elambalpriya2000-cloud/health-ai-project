...
Original file is located at
    https://colab.research.google.com/drive/18H6NTHLVaXY6RzTRL93VbmS4JtvWTbf2
"""
...
def treatment_plan(condition, age, genter, medical_history):
    prompt = f"generate personalized treatment suggestion for the following patient information. Include home remedies and general medication guidelines.\n\t"
    return generate_response(prompt, max_length=1200)

# create gradio interface
with gr.Blocks() as app:
    gr.Markdown("# Medical AI Assistant")
    gr.Markdown("**Disclaimer: This is for informational purpose only. Always consult healthcare professionals for medical advice.**")
